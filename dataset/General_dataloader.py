...
prefix = "C:\\cyt\\pj1\\pythonProject1\\pj12\\projectforwork\\Data\\Data_VOCformat4\\"
...
class GeneralDataset(Dataset):
    def __init__(self, mode="train", change=False):
        ...
        2：    不同的数据集要改类别标签，以及对应的颜色标签，也就是self.classes  和 self.colormap
    ...
    图片都在JPEGImages文件夹下面，需要在train.txt读取的每一行后面加上.jpg
