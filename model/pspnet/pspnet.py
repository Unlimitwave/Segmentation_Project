...
from pj12.projectforwork.model.pspnet.mobilenetv2 import mobilenetv2
from pj12.projectforwork.model.pspnet.resnet import resnet50
...
if __name__ == "__main__":
    ...
    net = PSPNet(21,backbone='mobilenet',downsample_factor=16, aux_branch=False, pretrained=False)
    output = net(img)
