...
from pj12.projectforwork.model.unet_123.layers import unetConv2

from pj12.projectforwork.model.unet_123.init_weights import init_weights


class UNet3Plus(nn.Module):
    def __init__(self, n_channels=3, n_classes=8, bilinear=True, feature_scale=4,
