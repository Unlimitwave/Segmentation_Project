...
from pj12.projectforwork.model.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
...
class Deeplabv3plus(nn.Module):
    def __init__(self, backbone, num_classes=8, os=16, freeze_bn=False):
...
#     Model123 = Deeplabv3plus(backbone=resnet50, num_classes=num_classes, os=os, freeze_bn=False)
#     return Model123


def Deeplabv3plus_res50(num_classes=8, os=16, pretrained=False):
...
def Deeplabv3plus_res101(num_classes=8, os=16, pretrained=False):
...
if __name__ == "__main__":
    ...
    net = Deeplabv3plus_res50(num_classes=8,os = 16, pretrained=False)
    output = net(img)
